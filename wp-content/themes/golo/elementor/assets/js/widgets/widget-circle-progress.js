(
	function( $ ) {
		...
		var CircleProgressChartHandler = function( $scope, $ ) {
			var $element = $scope.find( '.golo-circle-progress-chart' );
		...
		$( window ).on( 'elementor/frontend/init', function() {
			elementorFrontend.hooks.addAction( 'frontend/element_ready/golo-circle-progress-chart.default', CircleProgressChartHandler );
		} );
	}
)( jQuery );
