...
class Group_Control_Advanced_Border extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['type'] = [
			'label'     => _x( 'Type', 'Border Control', 'golo' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => [
				''       => __( 'Default', 'golo' ),
				'none'   => __( 'None', 'golo' ),
				'solid'  => _x( 'Solid', 'Border Control', 'golo' ),
				'double' => _x( 'Double', 'Border Control', 'golo' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'golo' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'golo' ),
				'groove' => _x( 'Groove', 'Border Control', 'golo' ),
			],
			'selectors' => [
		...
		$fields['color'] = [
			'label'     => _x( 'Color', 'Border Control', 'golo' ),
		...
		$fields['width'] = [
			'label'      => _x( 'Width', 'Border Control', 'golo' ),
		...
		$fields['radius'] = [
			'label'      => _x( 'Rounded', 'Border Control', 'golo' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [ 'px', '%' ],
			'selectors'  => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x( 'Border', 'Advanced Border Control', 'golo' ),
				'starter_name'  => 'enable',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',
