...
class Widget_Social_Networks extends Base {
	...
	public function get_name() {
		return 'golo-social-networks';
	}

	public function get_title() {
		return esc_html__( 'Social Networks', 'golo' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'style', [
			...
			'options' => [
				'icons'              => esc_html__( 'Icons', 'golo' ),
				'large-icons'        => esc_html__( 'Large Icons', 'golo' ),
				'flat-rounded-icon'  => esc_html__( 'Flat Rounded Icon', 'golo' ),
				'solid-rounded-icon' => esc_html__( 'Solid Rounded Icon', 'golo' ),
				'icon-title'         => esc_html__( 'Icon + Title', 'golo' ),
		...
		$this->add_control( 'layout', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'inline'      => esc_html__( 'Inline', 'golo' ),
				'list'        => esc_html__( 'List', 'golo' ),
				'two-columns' => esc_html__( '2 Columns', 'golo' ),
			],
			'default' => 'inline',
		] );
		...
		$this->add_control( 'items', [
			...
			'default'     => [
				[
					'title' => esc_html__( 'Facebook', 'golo' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
				...
				[
					'title' => esc_html__( 'Instagram', 'golo' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
				...
				[
					'title' => esc_html__( 'Linkedin', 'golo' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
	...
	private function add_style_section() {
		...
		$this->add_control( 'items_vertical_spacing', [
			'label'      => esc_html__( 'Items Vertical Spacing', 'golo' ),
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'golo-social-networks' );
	...
	protected function _content_template() {
		// @formatter:off
		?>
		<div class="golo-social-networks style-{{ settings.style }} layout-{{ settings.layout }}">
			<ul class="list">
				<#
				var iconsHTML = {};
				var linkClass = 'link';
