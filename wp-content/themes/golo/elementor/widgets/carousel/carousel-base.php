...
abstract class Carousel_Base extends Base {
	...
	public function get_script_depends() {
		return [ 'golo-group-widget-carousel' ];
	}
	...
	private function add_swiper_options_section() {
		$this->start_controls_section( 'swiper_options_section', [
			'label' => esc_html__( 'Carousel Options', 'golo' ),
		] );

		$this->add_responsive_control( 'swiper_items', [
			'label'          => esc_html__( 'Slides Per View', 'golo' ),
			'type'           => Controls_Manager::SELECT,
			'options'        => array(
				'auto'       => esc_html__( 'Auto', 'golo' ),
				'auto-fixed' => esc_html__( 'Auto - Fixed Width', 'golo' ),
				'1'          => '1',
				'2'          => '2',
				'3'          => '3',
				'4'          => '4',
		...
		$this->add_responsive_control( 'swiper_slides_width', [
			'label'       => esc_html__( 'Slides Width', 'golo' ),
		...
		$this->add_responsive_control( 'swiper_gutter', [
			'label'   => esc_html__( 'Space Between', 'golo' ),
		...
		$this->add_control( 'swiper_effect', [
			'label'   => esc_html__( 'Transition', 'golo' ),
			'type'    => Controls_Manager::SELECT,
			'options' => array(
				'slide' => esc_html__( 'Slide', 'golo' ),
				'fade'  => esc_html__( 'Fade', 'golo' ),
			),
			'default' => 'slide',
		] );
		...
		$this->add_control( 'swiper_autoplay', [
			'label'       => esc_html__( 'Auto Play', 'golo' ),
			'description' => esc_html__( 'Delay between transitions (in ms). For e.g: 3000. Leave blank to disabled. Input 1 to make smooth transition.', 'golo' ),
			'type'        => Controls_Manager::NUMBER,
			'default'     => '',
		] );

		$this->add_control( 'swiper_loop', [
			'label'   => esc_html__( 'Infinite Loop', 'golo' ),
			'type'    => Controls_Manager::SWITCHER,
			'default' => 'yes',
		] );

		$this->add_control( 'swiper_centered', [
			'label' => esc_html__( 'Centered', 'golo' ),
			'type'  => Controls_Manager::SWITCHER,
		] );

		$this->add_control( 'swiper_centered_highlight', [
			'label'     => esc_html__( 'Highlight Active Items', 'golo' ),
			'type'      => Controls_Manager::SWITCHER,
			'condition' => [
				'swiper_centered' => 'yes',
			],
		...
		$this->add_control( 'swiper_free_mode', [
			'label' => esc_html__( 'Free Mode', 'golo' ),
			'type'  => Controls_Manager::SWITCHER,
		] );

		$this->add_control( 'swiper_touch', [
			'label'       => esc_html__( 'Touchable', 'golo' ),
			'description' => esc_html__( 'Click and drag to change slides', 'golo' ),
			'type'        => Controls_Manager::SWITCHER,
			'default'     => 'yes',
		] );

		$this->add_control( 'swiper_mousewheel', [
			'label' => esc_html__( 'Mousewheel', 'golo' ),
			'type'  => Controls_Manager::SWITCHER,
		] );

		$this->add_control( 'swiper_navigation_heading', [
			'label'     => esc_html__( 'Navigation', 'golo' ),
		...
		$this->add_control( 'swiper_inner_heading', [
			'label'     => esc_html__( 'Slider Inner', 'golo' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$this->add_control( 'swiper_container_heading', [
			'label'     => esc_html__( 'Slider Container', 'golo' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$this->add_control( 'swiper_content_alignment_heading', [
			'label'     => esc_html__( 'Content Alignment', 'golo' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );

		$this->add_responsive_control( 'swiper_content_horizontal_align', [
			'label'       => esc_html__( 'Horizontal Align', 'golo' ),
			'label_block' => true,
		...
		$this->add_responsive_control( 'swiper_content_vertical_align', [
			'label'       => esc_html__( 'Vertical Align', 'golo' ),
			'label_block' => true,
			'type'        => Controls_Manager::CHOOSE,
	...
	private function add_swiper_arrows_popover() {
		...
		$this->add_control( 'swiper_arrows_aligned_by', [
			'label'       => esc_html__( 'Aligned By', 'golo' ),
			'type'        => Controls_Manager::SELECT,
			'options'     => [
				'slider' => esc_html__( 'Slider', 'golo' ),
		...
		$this->add_control( 'swiper_left_arrow_heading', [
			'label' => esc_html__( 'Left Arrow', 'golo' ),
			'type'  => Controls_Manager::HEADING,
		] );

		$this->add_responsive_control( 'swiper_left_arrow_margin', [
			'label'      => esc_html__( 'Offset', 'golo' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [ 'px', '%', 'em' ],
			'selectors'  => [
		...
		$this->add_control( 'swiper_right_arrow_heading', [
			'label' => esc_html__( 'Right Arrow', 'golo' ),
			'type'  => Controls_Manager::HEADING,
		] );
		...
		$this->add_control( 'swiper_arrows_visibility_heading', [
			'label' => esc_html__( 'Visibility', 'golo' ),
			'type'  => Controls_Manager::HEADING,
		] );

		$this->add_control( 'swiper_arrows_show_always', [
			'label' => esc_html__( 'Show Always', 'golo' ),
			'type'  => Controls_Manager::SWITCHER,
		] );
	...
	private function add_swiper_dots_popover() {
		...
		$this->add_control( 'swiper_dots_style', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'01' => esc_html__( '01 - Circle Bullets', 'golo' ),
				'02' => esc_html__( '02 - Rectangle Bullets', 'golo' ),
				'03' => esc_html__( '03 - Fraction', 'golo' ),
				'04' => esc_html__( '04 - Circle Fraction & Arrows', 'golo' ),
				'05' => esc_html__( '05 - Modern Circle Bullets', 'golo' ),
				'06' => esc_html__( '06 - Fraction 02', 'golo' ),
			],
			'default' => '01',
		] );
		...
		$this->add_responsive_control( 'swiper_dots_direction', [
			'label'   => esc_html__( 'Direction', 'golo' ),
			'type'    => Controls_Manager::CHOOSE,
			'options' => [
				'horizontal' => [
					'title' => esc_html__( 'Horizontal', 'golo' ),
					'icon'  => 'eicon-navigation-horizontal',
				],
				'vertical'   => [
					'title' => esc_html__( 'Vertical', 'golo' ),
		...
		$this->add_responsive_control( 'swiper_dots_vertical_align', [
			...
			'options'              => [
				...
				'below'  => [
					'title' => esc_html__( 'Below Slider', 'golo' ),
		...
		$this->add_responsive_control( 'swiper_dots_vertical_offset', [
			'label'       => esc_html__( 'Vertical Offset', 'golo' ),
			'type'        => Controls_Manager::SLIDER,
			'size_units'  => [ 'px', '%' ],
			'range'       => [
				'px' => [
		...
		$this->add_responsive_control( 'swiper_dots_horizontal_offset', [
			'label'       => esc_html__( 'Horizontal Offset', 'golo' ),
			'type'        => Controls_Manager::SLIDER,
			'size_units'  => [ 'px', '%' ],
			'range'       => [
				'px' => [
	...
	private function add_swiper_arrows_style_section() {
		$this->start_controls_section( 'swiper_arrows_style_section', [
			'label'     => esc_html__( 'Carousel Arrows', 'golo' ),
		...
		$this->add_responsive_control( 'swiper_arrows_icon_size', [
			'label'      => esc_html__( 'Icon Size', 'golo' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [ 'px' ],
			'range'      => [
				'px' => [
		...
		$this->add_responsive_control( 'swiper_arrows_border_width', [
			'label'     => esc_html__( 'Border Width', 'golo' ),
			'type'      => Controls_Manager::SLIDER,
			'selectors' => [
	...
	private function add_swiper_dots_style_section() {
		$this->start_controls_section( 'swiper_dots_style_section', [
			'label'     => esc_html__( 'Carousel Dots', 'golo' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
		...
		$this->add_control( 'swiper_dots_primary_color', [
			'label'     => esc_html__( 'Primary Color', 'golo' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$this->add_control( 'swiper_dots_secondary_color', [
			'label'     => esc_html__( 'Secondary Color', 'golo' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
	...
	protected function get_slider_settings( array $settings ) {
		$slider_settings = [
			'class'          => [ 'golo-swiper golo-slider-widget' ],
			'data-lg-items'  => $settings['swiper_items'],
			'data-lg-gutter' => $settings['swiper_gutter'],
		];

		if ( ! empty( $settings['swiper_items_tablet'] ) ) {
			$slider_settings['data-md-items'] = $settings['swiper_items_tablet'];
		} else {
			$slider_settings['data-md-items'] = 0;
		}

		if ( ! empty( $settings['swiper_items_mobile'] ) ) {
			$slider_settings['data-sm-items'] = $settings['swiper_items_mobile'];
		} else {
			$slider_settings['data-sm-items'] = 0;
		}

		if ( ! empty( $settings['swiper_gutter_tablet'] ) ) {
			$slider_settings['data-md-gutter'] = $settings['swiper_gutter_tablet'];
		} else {
			$slider_settings['data-md-gutter'] = 0;
		}

		if ( ! empty( $settings['swiper_gutter_mobile'] ) ) {
			$slider_settings['data-sm-gutter'] = $settings['swiper_gutter_mobile'];
		} else {
			$slider_settings['data-sm-gutter'] = 0;
		}
