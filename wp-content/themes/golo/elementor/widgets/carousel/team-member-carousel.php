...
class Widget_Team_Member_Carousel extends Static_Carousel {
	...
	public function get_name() {
		return 'golo-team-member-carousel';
	}

	public function get_title() {
		return esc_html__( 'Team Member Carousel', 'golo' );
	}
	...
	protected function add_repeater_controls( Repeater $repeater ) {
		...
		$repeater->add_control( 'socials', [
			'label'       => esc_html__( 'Socials', 'golo' ),
			'description' => esc_html__( 'One social per line. Icon class & url separator with |. For eg: fab fa-facebook|https://facebook.com', 'golo' ),
			'type'        => Controls_Manager::TEXTAREA,
		] );
	}
	...
	protected function print_slide() {
		...
		?>
		<div class="golo-team-member golo-box">
			<div class="item">
				<?php if ( $slide['image']['url'] ) : ?>
					<div class="photo golo-image">
	...
	protected function render() {
		$this->add_render_attribute( 'wrapper', 'class', 'golo-team-member-carousel' );
		?>
