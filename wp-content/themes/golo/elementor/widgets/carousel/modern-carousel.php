...
class Widget_Modern_Carousel extends Carousel_Base {
	...
	public function get_name() {
		return 'golo-modern-carousel';
	}

	public function get_title() {
		return esc_html__( 'Modern Carousel', 'golo' );
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'golo-modern-carousel' );
		?>
	...
	private function add_content_section() {
		...
		$this->add_control( 'style', [
			...
			'default'      => '01',
			'prefix_class' => 'golo-modern-carousel-style-',
		...
		$repeater->add_control( 'tags', [
			'label'       => esc_html__( 'Tags', 'golo' ),
			'type'        => Controls_Manager::TEXTAREA,
			'placeholder' => esc_html__( 'One tag per line', 'golo' ),
		] );
	...
	private function add_style_section() {
		...
		$this->add_responsive_control( 'box_border_radius', [
			...
			'size_units' => [ 'px', '%' ],
			'selectors'  => [
				'{{WRAPPER}} .golo-box' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		] );
		...
		$this->add_responsive_control( 'image_border_radius', [
			...
			'size_units' => [ 'px', '%' ],
			'selectors'  => [
				'{{WRAPPER}} .golo-image' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		] );
	...
	protected function print_slides( array $settings ) {
		...
		foreach ( $settings['slides'] as $slide ) :
			...
			$this->add_render_attribute( $box_key, 'class', 'golo-box slide-wrapper' );
