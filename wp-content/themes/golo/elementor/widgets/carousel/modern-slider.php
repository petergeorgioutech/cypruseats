...
class Widget_Modern_Slider extends Carousel_Base {
	...
	public function get_name() {
		return 'golo-modern-slider';
	}

	public function get_title() {
		return esc_html__( 'Modern Slider', 'golo' );
	}
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'golo-modern-slider' );
		?>
	...
	private function add_content_section() {
		...
		$this->add_control( 'layers_animation', [
			'label' => esc_html__( 'Layers Animation', 'golo' ),
		...
		$repeater->add_control( 'title', [
			...
			'default'     => esc_html__( 'Add Your Heading Text Here', 'golo' ),
		] );
		...
		$repeater->add_control( 'sub_title_heading', [
			'label'     => esc_html__( 'Sub Title', 'golo' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$repeater->add_control( 'sub_title', [
			...
			'placeholder' => esc_html__( 'Enter your sub title', 'golo' ),
			'default'     => '',
		] );
		...
		$repeater->add_control( 'background_animation', [
			'label'       => esc_html__( 'Background Animation', 'golo' ),
			'label_block' => true,
			'type'        => Controls_Manager::SELECT,
			'default'     => '',
			'options'     => [
				''          => esc_html__( 'None', 'golo' ),
				'ken-burns' => esc_html__( 'Ken Burns', 'golo' ),
			],
		] );
		...
		$repeater->add_control( 'title_hover_color', [
			'label'     => esc_html__( 'Hover Color', 'golo' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$repeater->add_group_control( Group_Control_Typography::get_type(), [
			...
			'label'    => esc_html__( 'Highlight Words Typography', 'golo' ),
			'selector' => '{{WRAPPER}} {{CURRENT_ITEM}} .title mark',
		] );

		$repeater->add_control( 'title_mark_color', [
			'label'     => esc_html__( 'Highlight Words Color', 'golo' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$repeater->add_control( 'button_text_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} {{CURRENT_ITEM}} .golo-button' => 'color: {{VALUE}};',
			],
		] );

		$repeater->add_control( 'button_text_border_color', [
			'label'     => esc_html__( 'Line Color', 'golo' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} {{CURRENT_ITEM}} .golo-button.style-bottom-line .button-content-wrapper:before' => 'background: {{VALUE}};',
				'{{WRAPPER}} {{CURRENT_ITEM}} .golo-button.style-left-line .button-content-wrapper:before'   => 'background: {{VALUE}};',
			],
			'condition' => [
		...
		$repeater->add_group_control( Group_Control_Background::get_type(), [
			...
			'types'    => [ 'classic', 'gradient' ],
			'selector' => '{{WRAPPER}} {{CURRENT_ITEM}} .golo-button:before',
		] );

		$repeater->add_control( 'button_hover_style_heading', [
			'label'     => esc_html__( 'Button Hover', 'golo' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$repeater->add_control( 'button_hover_text_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} {{CURRENT_ITEM}} .golo-button:hover' => 'color: {{VALUE}};',
			],
		] );
		...
		$repeater->add_control( 'button_hover_text_border_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} {{CURRENT_ITEM}} .golo-button.style-bottom-line .button-content-wrapper:after' => 'background: {{VALUE}};',
				'{{WRAPPER}} {{CURRENT_ITEM}} .golo-button.style-left-line .button-content-wrapper:after'   => 'background: {{VALUE}};',
			],
			'condition' => [
				'button_style' => [ 'text', 'text-left-line' ],
			],
		...
		$repeater->add_group_control( Group_Control_Background::get_type(), [
			...
			'types'    => [ 'classic', 'gradient' ],
			'selector' => '{{WRAPPER}} {{CURRENT_ITEM}} .golo-button:after',
		] );
	...
	protected function print_slides( array $settings ) {
		foreach ( $settings['slides'] as $slide ) :
			...
			$this->add_render_attribute( $item_key, 'class', [
				...
				'golo-slide-bg-animation-' . $slide['background_animation'],
			] );
									...
									<?php if ( '' !== $slide['sub_title'] ) : ?>
										...
										<div class="slide-layer-wrap sub-title-wrap">
											<div class="slide-layer">
												<h4 class="sub-title"><?php echo wp_kses( $slide['sub_title'], 'golo-default' ); ?></h4>
											</div>
										</div>
										...
										<div class="slide-layer-wrap title-wrap">
											<div class="slide-layer">
												...
												<a <?php $this->print_attributes_string( $item_title_link_key ); ?>>
													...
													<h3 class="title"><?php echo wp_kses( $slide['title'], 'golo-default' ); ?></h3>
