...
class Modify_Widget_Section extends Modify_Base {
	...
	public function section_layout( $element ) {
		...
		$section_gap['options'] = [
			...
			'default'  => esc_html__( 'Normal', 'golo' ),
			'no'       => esc_html__( 'No Gap', 'golo' ),
			'narrow'   => esc_html__( 'Narrow', 'golo' ),
			'extended' => esc_html__( 'Extended', 'golo' ),
			'wide'     => esc_html__( 'Wide', 'golo' ),
			'wider'    => esc_html__( 'Wider', 'golo' ),
		...
		$element->add_control( 'gap_beside', [
			'label'        => esc_html__( 'Gap Beside', 'golo' ),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'yes',
			'options'      => [
				'no'  => esc_html__( 'No', 'golo' ),
				'yes' => esc_html__( 'Yes', 'golo' ),
			],
		...
		$element->add_responsive_control( 'gap_width', [
			'label'     => esc_html__( 'Gap Width', 'golo' ),
		...
		$element->add_control( 'column_vertical_alignment', [
			'label'                => esc_html__( 'Column Vertical Alignment', 'golo' ),
			'label_block'          => true,
			'type'                 => Controls_Manager::CHOOSE,
