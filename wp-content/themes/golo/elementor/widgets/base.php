...
abstract class Base extends Widget_Base {
	...
	public function get_icon() {
		return 'golo-badge ' . $this->get_icon_part();
	}
	...
	protected function render_common_button() {
		...
		$this->add_render_attribute( 'button', 'class', 'golo-button style-' . $settings['button_style'] );

		if ( ! empty( $settings['button_size'] ) ) {
			$this->add_render_attribute( 'button', 'class', 'golo-button-' . $settings['button_size'] );
		}
	...
	protected function register_common_button_style_section() {
		...
		$this->add_control( 'button_margin', [
			...
			'size_units' => [ 'px', '%' ],
			'selectors'  => [
				'{{WRAPPER}} .golo-button-wrapper' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		] );
		...
		$this->add_group_control( Group_Control_Text_Gradient::get_type(), [
			'name'     => 'button_text',
			'selector' => '{{WRAPPER}} .golo-button .button-text',
		] );
		...
		$this->add_group_control( Group_Control_Box_Shadow::get_type(), [
			...
			'selector' => '{{WRAPPER}} .golo-box:hover div.golo-button, {{WRAPPER}} a.golo-button:hover',
		] );
		...
		$this->add_group_control( Group_Control_Text_Gradient::get_type(), [
			...
			'selector' => '{{WRAPPER}} .golo-box:hover div.golo-button .button-text, {{WRAPPER}} a.golo-button:hover .button-text',
		] );
		...
		$this->add_group_control( Group_Control_Text_Gradient::get_type(), [
			...
			'selector'  => '{{WRAPPER}} .golo-box:hover div.golo-button .button-icon, {{WRAPPER}} a.golo-button:hover .button-icon',
			'condition' => $icon_condition,
		] );
