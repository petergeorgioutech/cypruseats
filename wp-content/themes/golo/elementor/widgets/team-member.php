...
class Widget_Team_Member extends Base {
	...
	public function get_name() {
		return 'golo-team-member';
	}

	public function get_title() {
		return esc_html__( 'Team Member', 'golo' );
	}
	...
	private function add_content_section() {
		...
		$this->add_control( 'style', [
			...
			'prefix_class' => 'golo-team-member-style-',
		] );
		...
		$this->add_control( 'social_networks', [
			'label'       => esc_html__( 'Social Networks', 'golo' ),
			...
			'default'     => [
				...
				[
					'title' => esc_html__( 'Youtube Channel', 'golo' ),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'golo-team-member golo-box' );
		?>
					...
					<div class="info">
						...
						<?php if ( $settings['content'] !== '' ) : ?>
							<div class="description">
								<?php echo wp_kses( $settings['content'], 'golo-default' ); ?>
							</div>
						<?php endif; ?>
					</div>
				<?php endif; ?>
