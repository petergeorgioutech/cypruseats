...
class Widget_Timeline extends Base {
	...
	public function get_name() {
		return 'golo-timeline';
	}

	public function get_title() {
		return esc_html__( 'Timeline', 'golo' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control( 'items', [
			...
			'default'     => [
				[
					'title'       => esc_html__( 'Step #1', 'golo' ),
					'description' => esc_html__( 'Suspe ndisse suscipit sagittis leo sit met condimentum estibulum issim Lorem ipsum dolor sit amet, consectetur cium', 'golo' ),
				],
				[
					'title'       => esc_html__( 'Step #2', 'golo' ),
					'description' => esc_html__( 'Suspe ndisse suscipit sagittis leo sit met condimentum estibulum issim Lorem ipsum dolor sit amet, consectetur cium', 'golo' ),
				],
				[
					'title'       => esc_html__( 'Step #3', 'golo' ),
					'description' => esc_html__( 'Suspe ndisse suscipit sagittis leo sit met condimentum estibulum issim Lorem ipsum dolor sit amet, consectetur cium', 'golo' ),
				],
				[
					'title'       => esc_html__( 'Step #4', 'golo' ),
					'description' => esc_html__( 'Suspe ndisse suscipit sagittis leo sit met condimentum estibulum issim Lorem ipsum dolor sit amet, consectetur cium', 'golo' ),
				],
			],
			'title_field' => '{{{ title }}}',
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'golo-timeline style-01' );
		?>
		<div <?php $this->print_attributes_string( 'wrapper' ); ?>>
			<div class="timeline-line"></div>
			<?php if ( $settings['items'] && count( $settings['items'] ) > 0 ) { ?>
				<div class="timeline-list golo-entrance-animation-queue">
