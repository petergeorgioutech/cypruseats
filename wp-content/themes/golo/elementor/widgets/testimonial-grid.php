...
class Widget_Testimonial_Grid extends Base {
	...
	public function get_name() {
		return 'golo-testimonial-grid';
	}

	public function get_title() {
		return esc_html__( 'Testimonial Masonry', 'golo' );
	}
	...
	private function add_layout_section() {
		...
		$this->add_control( 'image_position', [
			'label'        => esc_html__( 'Image Position', 'golo' ),
	...
	private function add_content_section() {
		...
		$this->add_group_control( Group_Control_Image_Size::get_type(), [
			...
			'fields_options' => [
				'size' => [
					'label' => esc_html__( 'Thumbnail Size', 'golo' ),
				],
			],
		] );
		...
		$this->add_group_control( Group_Control_Image_Size::get_type(), [
			...
			'fields_options' => [
				'size' => [
					'label' => esc_html__( 'Avatar Size', 'golo' ),
				],
			],
		] );
	...
	private function add_thumbnail_style_section() {
		...
		$this->add_group_control( Group_Control_Css_Filter::get_type(), [
			'name'     => 'css_filters',
			'selector' => '{{WRAPPER}} .golo-image img',
		] );
		...
		$this->add_control( 'thumbnail_opacity', [
			...
			'selectors' => [
				'{{WRAPPER}} .golo-image img' => 'opacity: {{SIZE}};',
			],
		] );
		...
		$this->add_group_control( Group_Control_Box_Shadow::get_type(), [
			...
			'selector' => '{{WRAPPER}} .golo-box:hover .golo-image',
		] );

		$this->add_group_control( Group_Control_Css_Filter::get_type(), [
			'name'     => 'css_filters_hover',
			'selector' => '{{WRAPPER}} .golo-box:hover .golo-image img',
		] );
		...
		$this->add_control( 'thumbnail_opacity_hover', [
			...
			'selectors' => [
				'{{WRAPPER}} .golo-box:hover .golo-image img' => 'opacity: {{SIZE}};',
			],
		] );
				...
				<?php foreach ( $settings['items'] as $item ) : ?>
					...
					<div <?php $this->print_attributes_string( $this->get_current_key() ); ?>>
						...
						$this->add_render_attribute( $this->get_current_key() . '-testimonial', [
							'class' => 'golo-box testimonial-item',
						] );
						?>
	...
	private function print_testimonial_thumbnail() {
		...
		?>
		<div class="golo-image thumbnail">
			<?php echo \Golo_Image::get_elementor_attachment( [
				'settings'       => $item,
				'image_key'      => 'thumbnail',
	...
	private function print_layout() {
		...
		<?php if ( $item['content'] ) : ?>
			<div class="content">
				...
				<div class="text">
					<?php echo wp_kses( $item['content'], 'golo-default' ); ?>
				</div>
			</div>
		<?php endif; ?>
