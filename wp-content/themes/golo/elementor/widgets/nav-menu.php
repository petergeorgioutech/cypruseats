...
class Widget_Nav_Menu extends Base {
	...
	public function get_name() {
		return 'golo-modern-menu';
	}

	public function get_title() {
		return esc_html__( 'Modern Menu', 'golo' );
	}
	...
	protected function _register_controls() {
		...
		if ( ! empty( $menus ) ) {
			$this->add_control(
				...
				[
					...
					'save_default' => true,
					'separator' => 'after',
					'description' => sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'golo' ), admin_url( 'nav-menus.php' ) ),
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'raw' => '<strong>' . __( 'There are no menus in your site.', 'golo' ) . '</strong><br>' . sprintf( __( 'Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'golo' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
					'separator' => 'after',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'horizontal',
				'options' => [
					'horizontal' => __( 'Horizontal', 'golo' ),
					'dropdown' => __( 'Dropdown', 'golo' ),
				],
		...
		$this->add_control(
			'pointer',
			[
				'label' => __( 'Pointer', 'golo' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'underline',
				'options' => [
					'none' => __( 'None', 'golo' ),
					'underline' => __( 'Underline', 'golo' ),
					'overline' => __( 'Overline', 'golo' ),
					'double-line' => __( 'Double Line', 'golo' ),
					'framed' => __( 'Framed', 'golo' ),
					'background' => __( 'Background', 'golo' ),
					'text' => __( 'Text', 'golo' ),
				],
				'style_transfer' => true,
				'condition' => [
		...
		$this->add_control(
			'indicator',
			[
				'label' => __( 'Submenu Indicator', 'golo' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'classic',
				'options' => [
					'none' => __( 'None', 'golo' ),
					'classic' => __( 'Classic', 'golo' ),
					'chevron' => __( 'Chevron', 'golo' ),
					'angle' => __( 'Angle', 'golo' ),
					'plus' => __( 'Plus', 'golo' ),
				],
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Horizontal Padding', 'golo' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Vertical Padding', 'golo' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Color', 'golo' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'raw' => __( 'On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'golo' ),
				'type' => Controls_Manager::RAW_HTML,
			...
			<div class="mb-menu canvas-menu canvas-left <?php echo esc_attr('elementor-nav-menu--layout-' . $settings['layout']); ?>">
				...
				<div class="site-menu area-menu mobile-menu">
					...
					<div class="inner-menu custom-scrollbar">
						...
						<?php \Golo_Templates::site_logo('dark'); ?>
