...
class Widget_Image_Layers extends Base {
	...
	public function get_name() {
		return 'golo-image-layers';
	}

	public function get_title() {
		return esc_html__( 'Image Layers', 'golo' );
	}
	...
	private function add_artboard_section() {
		$this->start_controls_section( 'artboard_section', [
			'label' => esc_html__( 'Artboard', 'golo' ),
		] );
	...
	private function add_layers_section() {
		$this->start_controls_section( 'layers_section', [
			'label' => esc_html__( 'Layers', 'golo' ),
		] );

		$repeater = new Repeater();

		$repeater->add_control( 'static', [
			'label' => esc_html__( 'Static Layer', 'golo' ),
		...
		$repeater->add_control( 'loop', [
			...
			'options' => [
				...
				'rotate'          => esc_html__( 'Rotate', 'golo' ),
				'move-horizontal' => esc_html__( 'Move - Horizontal', 'golo' ),
				'move-vertical'   => esc_html__( 'Move - Vertical', 'golo' ),
			],
			'default' => '',
		] );
