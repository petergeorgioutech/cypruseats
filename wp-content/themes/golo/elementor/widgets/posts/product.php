...
class Widget_Product extends Posts_Base {
	...
	public function get_title() {
		return esc_html__( 'Product', 'golo' );
	}
	...
	private function add_grid_options_section() {
		...
		$this->add_responsive_control( 'grid_column_gutter', [
			'label'     => esc_html__( 'Column Gutter', 'golo' ),
			'type'      => Controls_Manager::NUMBER,
			'min'       => 0,
			'max'       => 200,
			'step'      => 1,
		...
		$this->add_responsive_control( 'grid_row_gutter', [
			'label'     => esc_html__( 'Row Gutter', 'golo' ),
			'type'      => Controls_Manager::NUMBER,
			'min'       => 0,
			'max'       => 200,
			'step'      => 1,
	...
	private function add_caption_style_section() {
		...
		$this->add_control( 'caption_title_heading', [
			'label'     => esc_html__( 'Product Name', 'golo' ),
		...
		$this->add_control( 'caption_price_heading', [
			'label'     => esc_html__( 'Product Price', 'golo' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
	...
	protected function render() {
		...
		$this->add_render_attribute( 'wrapper', 'class', 'golo-grid-wrapper golo-product style-grid-01' );
