...
$metro_item_count   = 0;
$count              = $golo_query->post_count;

while ( $golo_query->have_posts() ) : $golo_query->the_post();
	...
	>
		<div class="post-wrapper golo-box">
			<div class="post-thumbnail-wrapper golo-image grid-item-height">

				<div class="post-thumbnail">
					<a href="<?php the_permalink(); ?>">
						<?php if ( has_post_thumbnail() ) { ?>
							<?php
							Golo_Image::the_post_thumbnail( array(
								'size'   => 'custom',
								'width'  => $_image_width,
							...
							?>
						<?php } else { ?>
							<?php Golo_Templates::image_placeholder( 480, 480 ); ?>
						<?php } ?>
					</a>
				</div>
