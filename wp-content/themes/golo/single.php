...
$post_single_sidebar = Golo_Helper::get_setting('post_single_sidebar');
$elementor_page      = get_post_meta( get_the_ID(), '_elementor_edit_mode', true );

$sidebar = !empty($_GET['sidebar']) ? Golo_Helper::golo_clean(wp_unslash($_GET['sidebar'])) : $post_single_sidebar;
