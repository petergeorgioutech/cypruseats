	...
	abstract class GLF_Field
	{
		...
		public function html_clone_button_add()
		{
			...
			<button class="<?php echo esc_attr($btn_class); ?>"
			        type="button"><?php echo esc_html__('+ Add more', 'golo-framework'); ?></button>
		<?php
		}
		...
		public function html_start()
		{
			...
			<?php if (($this->parent_type === 'row') || ($this->parent_type === 'repeater')): ?>
				<div id="<?php echo esc_attr($this->get_id()); ?>"
					...
					<?php $this->the_preset(); ?>
					class="glf-field glf-col glf-col-<?php echo esc_attr($this->get_col()); ?> <?php echo esc_attr($this->get_layout() . '-col'); ?> <?php echo(isset($this->params['type']) ? 'glf-field-' . $this->params['type'] : ''); ?>">
						<?php $this->html_label(); ?>
			...
			<?php else: ?>
				<div id="<?php echo esc_attr($this->get_id()); ?>"
					...
					data-field-map="<?php echo esc_attr($this->field_map()); ?>"
					data-input-name="<?php echo esc_attr($this->get_input_name()); ?>"
					class="glf-field glf-row-outer <?php echo(isset($this->params['type']) ? 'glf-field-' . $this->params['type'] : ''); ?> <?php echo esc_attr($this->get_layout()); ?>">
					<div class="glf-row">
