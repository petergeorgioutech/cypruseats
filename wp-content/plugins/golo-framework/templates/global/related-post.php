...
$related = get_posts(array(
    ...
    'meta_query' => array(
        array(
            'key' => GOLO_METABOX_PREFIX . 'post_city',
...
$slick_attributes = array(
    ...
    '"autoplaySpeed": 5000',
    '"arrows": false',
    '"responsive": [{ "breakpoint": 376, "settings": {"slidesToShow": 2,"infinite": true, "swipeToSlide": true, "dots": true} },{ "breakpoint": 479, "settings": {"slidesToShow": 2,"infinite": true, "swipeToSlide": true, "dots": true} },{ "breakpoint": 650, "settings": {"slidesToShow": 2} },{ "breakpoint": 768, "settings": {"slidesToShow": 3} },{ "breakpoint": 1200, "settings": {"slidesToShow": 4} } ]'
);
...
<div class="related-post city-related-post pd-top-50 pd-bottom-40">
    ...
    <div class="container">
        ...
        foreach( $related as $related_post ) {
            ...
            $thumb_url = golo_image_resize($attach_id, $size);
            ?>
