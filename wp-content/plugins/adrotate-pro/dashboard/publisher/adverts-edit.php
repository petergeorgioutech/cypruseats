		...
		<table class="widefat" style="margin-top: .5em">
			...
			<?php if($adrotate_config['stats'] == 1) { ?>
	     	<tr>
		        ...
		        <td colspan="3"><input tabindex="36" name="adrotate_budget" type="text" size="10" class="ajdg-inputfield" autocomplete="off" value="<?php echo number_format($edit_banner->budget, 2, '.', '');?>" /> <em><?php _e('When the budget reaches 0, the advert will expire.', 'adrotate-pro'); ?></em></td>
			</tr>
			<tr>
