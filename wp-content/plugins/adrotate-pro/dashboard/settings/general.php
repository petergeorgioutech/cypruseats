...
<table class="form-table">
	<tr>
		...
		<td>
			<?php echo (is_writable(WP_CONTENT_DIR.'/'.$adrotate_config['banner_folder'])) ? '<img src="'.plugins_url('../../images/tick.png', __FILE__).'" width="10" height"10" title="Folder writable!" />' : '<img src="'.plugins_url('../../images/cross.png', __FILE__).'" width="10" height"10" title="Folder missing or unwritable!" />'; ?> <?php echo WP_CONTENT_DIR; ?>/<input name="adrotate_banner_folder" type="text" class="search-input" size="20" value="<?php echo $adrotate_config['banner_folder']; ?>" autocomplete="off" />/ <?php _e('(Default: banners).', 'adrotate-pro'); ?><br />
...
<table class="form-table">
	<tr>
		...
		<td>
			<?php echo (file_exists(ABSPATH.$adrotate_config['adstxt_file'].'ads.txt')) ? '<img src="'.plugins_url('../../images/tick.png', __FILE__).'" width="10" height"10" title="File found!" />' : '<img src="'.plugins_url('../../images/cross.png', __FILE__).'" width="10" height"10" title="File missing!" />'; ?> <?php echo get_site_url(); ?>/<input name="adrotate_adstxt_file" type="text" class="search-input" size="20" value="<?php echo $adrotate_config['adstxt_file']; ?>" autocomplete="off" />ads.txt.<br />
